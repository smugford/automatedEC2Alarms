description: Create/Update ELB/TG listener Alarms
schemaVersion: '0.3'
...
parameters:
  ...
  protocol:
    type: String
    description: (Required) Type of the application or network load balancer
mainSteps:
  - name: createListenersAlarms
  ...
  - name: onFailure
    ...
    inputs:
      ...
      InputPayload:
        elbname: '{{ createListenersAlarms.loadBalancerName }}'
        sns_topic_high: '${sns_topic_high}'
    isEnd: true
